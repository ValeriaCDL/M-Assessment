...
const ProfileList = () => {
    ...
    //getPokelist.catch(error => { console.error(error); });
    ...
    return (
        <>
            ...
            <div className="row justify-content-center">
                ...
                <div className="col-sm-12 col-md-8 bg-theme-light rounded m-3 p-4" onClick={()=> alert("I was clicked")}>
            ...
            <div className="row justify-content-center">
                ...
                <Col sm={12} md={8} className="bg-theme-light rounded m-3 p-4" key={p.id} onClick={()=> alert("I was clicked too")}>
                    <Row>
